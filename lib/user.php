...
class User {
  ...
  public function user_register($new_user_id, $new_user_name, $new_user_email, $new_user_password_hash, $new_user_recovery_code) {
    ...
    password_hash, profile_photo) VALUES ('{$this -> user_id}', 
    '{$this -> user_name}', '{$this -> user_email}', 
    '{$this -> user_recovery_code}', '{$this -> user_password_hash}', 0);";
