...
<body>
    ...
    <ul id="slide-out" class="sidenav">
        ...
        <li><a href="#settingsModal" class="waves-effect modal-trigger"><i class="material-icons">settings</i>Settings</a></li>
        <li><a href="#aboutUsModal" class="waves-effect modal-trigger"><i class="material-icons">supervisor_account</i>About Us</a></li>
        <li><a href="#contactModal" class="waves-effect modal-trigger"><i class="material-icons">message</i>Contact</a></li>
        ...
        <li><a href="#!"><i class="material-icons">check_box</i>Current</a></li>
    ...
    <form method="post" action="index.php">
        <div id="newBox" class="modal">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="modal-close btn-large waves-effect waves-green btn-flat transparent"><i class="material-icons">check</i></button>
            </div>
        </div>
    </form>
    <!-- Modal Settings -->
